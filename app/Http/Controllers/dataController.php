...
class dataController extends Controller
{
    ...
    {
        // return view('Data_tahunan.create');

        // Ambil user yang login
        $user = Auth::user();

        // Ambil daftar data berdasarkan id_skpd user yang login
        $daftarData = skpd::where('id_skpd', $user->id_skpd)->get();
        
        // Kirim data ke view
        return view('Data_tahunan.create', compact('daftarData'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to('dashboard')->with('succes', 'berhasil menambahkan data');
    }
    ...
    public function edit(string $id)
        {
            ...
            $data = data_tahunan::where('id', $id)->first();
        
            // Ambil daftar data sesuai dengan id_skpd user
            $daftarData = skpd::where('id_skpd', $user->id_skpd)->get();
        
            // Kirim data yang diperlukan ke view
            return view('Data_tahunan.edit', compact('data', 'daftarData'));
        }
    ...
    public function update(Request $request, string $id)
    {
        $request->validate([
            ...
            'id_daftar_data.numeric'=>'data id daftar data harus berupa numeric',
            'id_skdp.required'=>'Tolong inputkan data id skpd yang valid',
            'id_skpd.numeric'=>'data id skpd harus berupa numeric',
            'tahun.required'=>'Tolong inputkan data tahun yang valid',
            'tahun.numeric'=>'data tahun harus berupa numeric',
            'keterangan.required'=>'Tolong inputkan data keterangan yang valid',
            'nilai.required'=>'Tolong inputkan data nilai yang valid',
        ...
        data_tahunan::where('id', $id)->update($data);
        return redirect()->to('dashboard')->with('succes', 'data berhasil di update');
    }
    ...
    {
        data_tahunan::where('id', $id)->delete();
        return redirect()->to('dashboard')->with('succes', 'data berhasil di hapus');
    }
}
